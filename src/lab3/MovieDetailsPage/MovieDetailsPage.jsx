...
function MovieDetailsPage() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.themoviedb.org/3/movie/${id}?api_key=aec7a120efc0f2607c66f43ac96e5187&language=${language}`
      )
      .then((data) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="row justify-content-center mx-auto my-3 p-5"
        style={{
          background:
            "linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, #343a40 100%)",
          height: "100%",
          width: "100%",
          position: "absolute",
          top: 0,
      ...
      >
        ...
        <div
          className={`col-8 text-white ${textAlignment}`}
        ...
        >
          ...
          <p className="fs-5">
            {language === "en"
              ...
              : "العنوان الفرعي: " + details.tagline}
          </p>
          ...
          <p className="fs-5">
            {language === "en"
              ...
              : "تاريخ الاصدار: " + details.release_date}
          </p>
          <p className="fs-5">
            {language === "en"
              ? "Vote Count: " + details.vote_count
              : "عدد الأصوات: " + details.vote_count}
          </p>
          <p className="fs-5">
            {language === "en"
              ? "Rating: " + details.vote_average + " / 10"
              : "تصنيف: " + details.vote_average + " / 10"}
          </p>
          <p className="fs-5">
            {language === "en"
              ? "Runtime: " + details.runtime + " minutes"
              : "وقت التشغيل: " + details.runtime + " دقيقة"}
          </p>
          {/* <p className='fs-5'>
      ...
      <i
        className={`bi bi-heart${
          isFaved ? "-fill" : ""
        } bg-white rounded-circle px-2 py-1`}
        style={{
          position: "absolute",
          top: "35px",
